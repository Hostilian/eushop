...
-- conversations.participant_1_id FK -> users(id) was never indexed (conversations got no indexes at all in 001).
...
-- conversations.participant_2_id FK -> users(id) was never indexed. Same rationale as participant_1_id.
...
COMMENT ON INDEX idx_conversations_participant_1_id IS 'Backs conversations.participant_1_id FK -> users(id).';
COMMENT ON INDEX idx_conversations_participant_2_id IS 'Backs conversations.participant_2_id FK -> users(id).';
